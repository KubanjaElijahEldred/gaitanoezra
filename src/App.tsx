...
import { Sparkles, Menu, X, ExternalLink, MapPin, Briefcase } from "lucide-react";
...
// Professional Modern interactive designer signature brand logo component
export function EzraCollectiveLogo({ className = "h-10" }: { className?: string }) {
  return (
    <div className={`flex items-center select-none ${className}`}>
      <div className="flex flex-col items-start leading-none relative group cursor-pointer text-left">
        <div className="absolute -top-3.5 right-0 font-mono text-[8px] text-gray-500 tracking-[0.1em] flex gap-1.5 items-center select-none">
          <span>ESTD</span>
          <span className="text-orange-brand font-bold">2020</span>
        </div>
        <div className="flex items-baseline font-display font-black text-xl tracking-tight text-white transition-colors duration-300 group-hover:text-orange-brand">
          <span className="lowercase font-bold">ezra</span>
          <span className="text-orange-brand text-2xl font-black font-mono">.</span>
        </div>
        <div className="text-[9px] font-sans font-black tracking-[0.4em] text-gray-400 mt-0.5 leading-none select-none uppercase group-hover:text-white transition-colors">
          COLLECTIVE
        </div>
      </div>
    </div>
...
export default function App() {
  ...
  return (
    <div id="root-app" className="min-h-screen bg-dark-bg text-gray-200 selection:bg-orange-brand selection:text-white font-sans antialiased flex flex-col justify-between">
      ...
      <nav id="nav-header" className="fixed top-0 left-0 right-0 z-50 bg-dark-bg/85 backdrop-blur-md border-b border-border-card/60 transition-all">
        <div className="max-w-7xl mx-auto px-6 h-20 flex justify-between items-center">
          ...
          <button 
            ...
            className="md:hidden p-2 text-gray-400 hover:text-white transition-colors focus:outline-none cursor-pointer"
      ...
      <footer className="py-12 px-6 border-t border-border-card bg-black w-full">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-6 text-gray-500 text-xs">
          ...
          <div className="flex gap-6 font-mono text-[10px]">
            <a href="https://instagram.com/geatano_ezra" target="_blank" rel="noopener noreferrer" className="hover:text-orange-brand transition-colors flex items-center gap-1 uppercase">
